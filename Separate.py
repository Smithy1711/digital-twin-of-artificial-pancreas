...
resultJ = minimize(objectiveJ, x0=[0.05,0.005], args=(dataJ,))
...
resultL = minimize(objectiveL, x0=0.01, args=(dataL,))
kgl = resultL.x[0]

print("Fitted parameter for Stomach:")
print(f"kjs: {kjs}")

print("Fitted parameter for Insulin:")
print(f"kxi: {kxi}")

print("Optimized parameters for Jejunum:")
print(f"kgj: {kgj}")
print(f"kjl: {kjl}")

print("Optimized parameters for Ileum: ")
print(f"kgl: {kgl}")
