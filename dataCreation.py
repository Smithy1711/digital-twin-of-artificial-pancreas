...
np.savetxt('Data/dataS.csv', S, delimiter=',')
np.savetxt('Data/dataG.csv', G, delimiter=',')
np.savetxt('Data/dataI.csv', I, delimiter=',')
np.savetxt('Data/dataJ.csv', J, delimiter=',')
np.savetxt('Data/dataL.csv', L, delimiter=',')
np.savetxt('Data/dataGprod.csv', Gprod, delimiter=',')
